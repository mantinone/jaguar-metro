...
ALTER TABLE "STATION_AND_TRAIN" ADD FOREIGN KEY ("STATION_id") REFERENCES "STATION" ("id");
ALTER TABLE "STATION_AND_TRAIN" ADD FOREIGN KEY ("TRAIN_id") REFERENCES "TRAIN" ("id");
ALTER TABLE "TRAIN_AND_PASSENGER" ADD FOREIGN KEY ("TRAIN.id") REFERENCES "TRAIN" ("id");
ALTER TABLE "TRAIN_AND_PASSENGER" ADD FOREIGN KEY ("PASSENGER_id") REFERENCES "PASSENGER" ("id");
ALTER TABLE "STATION_AND_PASSENGER" ADD FOREIGN KEY ("STATION_id") REFERENCES "STATION" ("id");
ALTER TABLE "STATION_AND_PASSENGER" ADD FOREIGN KEY ("PASSENGER_id") REFERENCES "PASSENGER" ("id");
ALTER TABLE "TICKET" ADD FOREIGN KEY ("STATION_id") REFERENCES "STATION" ("id");
